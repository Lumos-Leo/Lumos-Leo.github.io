...
# Publications 
- [Deep Learning Empowered Super-Resolution: A Comprehensive Survey and Future Prospects](https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=11197230), Le Zhang, **Ao Li**, Qibin Hou, Ce Zhu, Yonina C. Eldar, **Proceedings of the IEEE**, 2025. $\color{#f00}{{（CCF A 类期刊）}}$
- [Towards Real Zero-Shot Camouflaged Object Segmentation without Camouflaged Annotations](https://arxiv.org/abs/2410.16953), Cheng Lei, Jie Fan, Xinran Li, Tianzhu Xiang, **Ao Li**, Ce Zhu, Le Zhang, **IEEE T-PAMI**, 2025. $\color{#f00}{{（CCF A 类期刊）}}$
- [MobileIE: An Extremely Lightweight and Effective ConvNet for Real-Time Image Enhancement on Mobile Devices](https://arxiv.org/abs/2507.01838), Hailong Yan, **Ao Li**, Xiangtao Zhang, Zhe Liu, Zenglin Shi, Ce Zhu, Le Zhang, **ICCV**, 2025. $\color{#f00}{{（CCF A 类会议）}}$
...
- [Exploring frequency-inspired optimization in transformer for efficient single image super-resolution](https://github.com/AVC2-UESTC/Frequency-Inspired-Optimization-for-EfficientSR), **Ao Li**, Le Zhang, Yun Liu, Ce Zhu, **IEEE T-PAMI**, 2025. $\color{#f00}{{（CCF A 类期刊）}}$
- [Feature modulation transformer: Cross-refinement of global representation via high-frequency prior for image super-resolution](https://github.com/AVC2-UESTC/CRAFT-SR), **Ao Li**, Le Zhang, Yun Liu, Ce Zhu, **ICCV**, 2023. $\color{#f00}{{（CCF A 类会议）}}$
